...
@Component({ selector: 'app-ga-workforce-programs', standalone: true, imports: [CommonModule], templateUrl: './workforce-programs.component.html' })
export class GAWorkforceProgramsComponent implements OnInit {
  svc = inject(AuditorService); programs: EmploymentProgram[] = []; loading = true;
